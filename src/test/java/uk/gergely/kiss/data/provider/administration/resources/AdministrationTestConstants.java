...
public class AdministrationTestConstants {
	...
	public static final String[] PERMISSION_ENUMS_STRING_VALUES_FOR_ADMINISTRATION = { "ANY", "CREATE", "READ", "EXECUTE", "DELETE" };
	public static final String[] ROLE_ENUMS_STRING_VALUES_FOR_ADMINISTRATION = { "AUTHORIZATION", "USER", "ALL" };
